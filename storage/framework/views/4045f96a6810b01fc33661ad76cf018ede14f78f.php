...
<?php $__env->startSection('title', 'التحكم بالإشعارات من داخل التطبيق'); ?>
            ...
            <div class="card-box">
                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($i); ?></td>
                            <td><?php echo e($row->body['ar']); ?></td>
                            <td><?php echo e($row->title['ar']); ?></td>
                            <td><?php echo e($row->user->email ?? null); ?></td>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form method="post" enctype="multipart/form-data"
                                              action="<?php echo e(route('deletedspecial-notifications')); ?>">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmedhamada/public_html/ahmedhamada/resources/views/admin/notifications/all.blade.php ENDPATH**/ ?>