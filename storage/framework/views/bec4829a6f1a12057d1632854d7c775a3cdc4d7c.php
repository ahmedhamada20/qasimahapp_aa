    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <form method="post" action="<?php echo e(route('createSubItems')); ?>"
                              enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>

                            <input type="hidden" value="<?php echo e($row->id); ?>" name="item_id">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?php echo e($row->discount_code); ?>"
                                       name="discount_code"
                                       id="exampleInputEmail1"
                                       placeholder="الكود">
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\work qasimahapp\ahmedhamada22\ahmedhamada\resources\views/admin/items/subItems.blade.php ENDPATH**/ ?>