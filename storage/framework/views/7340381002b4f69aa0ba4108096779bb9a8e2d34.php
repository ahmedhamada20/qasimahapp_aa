    ...
    <?php $__env->startSection('title', 'المساعدة'); ?>
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap"
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-info waves-effect waves-light" data-toggle="modal"
                                            data-target="#showMesages<?php echo e($row->id); ?>">عرض الرساله
                                        </button>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form method="post" enctype="multipart/form-data"
                                                    action="<?php echo e(route('helps.destroy', $row->id)); ?>">
                                                    <?php echo csrf_field(); ?>
                                ...
                                <div id="showMesages<?php echo e($row->id); ?>" class="modal fade" tabindex="-1" role="dialog"
                                    aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmedhamada/public_html/ahmedhamada/resources/views/admin/helps/index.blade.php ENDPATH**/ ?>