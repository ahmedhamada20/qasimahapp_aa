            ...
            <div class="card-box">
                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                    ...
                    <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <tr class="<?php echo e($row->type == 'popup' ? 'bg-primary' : ''); ?>">
                            <td><?php echo e($i); ?></td>
                            <td><?php echo e($row->type()); ?></td>
                            <td><?php echo e($row->url ?? 'لا يوجد'); ?></td>
                            <td>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmedhamada/public_html/ahmedhamada/resources/views/admin/banners/index.blade.php ENDPATH**/ ?>