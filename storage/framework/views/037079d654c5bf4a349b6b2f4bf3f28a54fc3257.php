    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                ...
                <a href="<?php echo e(route('export')); ?>" class="btn btn-info">Items</a>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\work qasimahapp\ahmedhamada22\ahmedhamada\resources\views/admin/items/index.blade.php ENDPATH**/ ?>