<?php $__env->startSection('title', "الماركات"); ?>
                    ...
                    <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo e(route('brands.edit',$row->id)); ?>">
                                    <button type="button"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form method="post" enctype="multipart/form-data"
                                              action="<?php echo e(route('brands.destroy',$row->id)); ?>">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmedhamada/public_html/ahmedhamada/resources/views/admin/brands/index.blade.php ENDPATH**/ ?>