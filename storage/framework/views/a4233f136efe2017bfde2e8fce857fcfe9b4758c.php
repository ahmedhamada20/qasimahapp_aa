<?php $__env->startSection('title', "مستخدمين الموقع"); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                ...
                <h4 class="header-title">مستخدمين الموقع</h4>
                <p class="sub-header">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form method="post" enctype="multipart/form-data"
                                              action="<?php echo e(route('users.destroy',$row->id)); ?>">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmedhamada/public_html/ahmedhamada/resources/views/admin/users/index.blade.php ENDPATH**/ ?>