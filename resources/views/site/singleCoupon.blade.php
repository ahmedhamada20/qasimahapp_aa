    ...
    <div class="mmain_card">
        <div class="card_head">
            <div class="ci_img">
                ...
                <div class="ci_img_info">
                    <h1 class="h6">{{$page->h1_header[App::getLocale()] ?? $item->title[App::getLocale()]}}</h1>
        ...
        <div class="card_foot">
            <a href="" class="copy_code" onClick='copy_data(select_txt{{$item->id}},"{{$item->id}}","{{$item->title[App::getLocale()]}}")'>
                ...
                <span id="select_txt{{$item->id}}" style="margin:0!important">{{$item->discount_code}}</span>
            </a>
...
<div class="col-sm-12">
    <img src="{{$siteBanner}}" alt="{{$page->h1_header[App::getLocale()] ?? ''}}" width="100%">
</div>

<div class="col-sm-12">
    <img src="{{$page->banner_path}}" alt="{{$page->h1_header[App::getLocale()] ?? ''}}" width="100%">
</div>
