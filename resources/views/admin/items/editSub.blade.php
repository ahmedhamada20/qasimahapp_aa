    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <form method="post" action="{{route('post-edit-sub-item')}}"
                          ...
                          @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="show" class="form-control" id="exampleSelect1">
                                    ...
                                    <option value="1" {{$row->show == "1" ? 'selected' : null}}> مفعل</option>
                                    <option value="0" {{$row->show == "0" ? 'selected' : null}}>غير مفعل</option>
                                </select>
                                @if ($errors->has('category_id'))
                                    <small class="text-danger">{{ $errors->first('category_id') }}</small>
                                @endif
