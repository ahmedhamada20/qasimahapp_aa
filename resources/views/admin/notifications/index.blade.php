                        ...
                        <form method="post" action="{{ route('notifications.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea name="body_ar" class="form-control" required placeholder="المحتوي باللغه العربية">{{ old('body_ar') }}</textarea>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea name="body_en" class="form-control" placeholder="المحتوي باللغه الإنجليزية">{{ old('body_en') }}</textarea>
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <select id="user_id" class="form-control"  multiple>
                                        ...
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}" onclick="userIdElemClickن (event)">
                                                {{ $user->email }}</option>
                                        @endforeach
                                    </select>
                                </div>
